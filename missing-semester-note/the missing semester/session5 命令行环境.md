...
> 可以使用stow管理dotfiles的symlinks软链接
> ```
> ~/dotfiles/zsh/.zshrc
> dotfiles > stow zsh
> 会帮助我们自动建立home目录的软链接 ~/.zshrc -> ~/dotfiles/zsh/.zshrc
> ```
...
**本地端口转发** ![](https://i.stack.imgur.com/a28N8.png%C2%A0)

**远程端口转发** ![](https://i.stack.imgur.com/4iK3b.png%C2%A0)
